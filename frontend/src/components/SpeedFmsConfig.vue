...
<template>
    ...
    <CustomDialog v-model:visible="dialogFormVisible" title="FMS速度配置" :width="300" :height="300" :min-width="400"
        :min-height="100" :max-width="1200" :max-height="800" :draggable="true" :resizable="true">
